...
proxy = [
            '202.55.5.209:8090' ,"121.13.252.58:41564","183.247.215.218:30001",
            "122.226.57.70:8888","124.156.100.83:8118","218.75.102.198:8000",
            "118.163.120.181:58837","122.9.101.6:8888","111.3.118.247:30001",
            "61.216.185.88:60808","111.3.118.247:30001"
        ]
headers = {'Connection': 'close','User-Agent': random.choice(USER_AGENTS)}
...
def getResponse(url):
    try:
        resp = requests.get(url,timeout=5,verify=False,headers=headers,proxies=proxies)
